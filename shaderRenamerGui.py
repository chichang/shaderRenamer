...
#                                                                                
# Created: Thu Feb 12 18:04:10 2015                                              
...
class Ui_shaderRenamerGUI(object):
    def setupUi(self, shaderRenamerGUI):
        ...
        shaderRenamerGUI.resize(676, 851)                 
        ...
        self.nodeTypeLabel = QtGui.QLabel(self.centralwidget)                                         
        self.nodeTypeLabel.setObjectName("nodeTypeLabel")                                             
        self.midLeft_GridLayout.addWidget(self.nodeTypeLabel, 2, 2, 1, 1)                             
        self.shaderTypeLabel = QtGui.QLabel(self.centralwidget)                                       
        self.shaderTypeLabel.setObjectName("shaderTypeLabel")                                         
        self.midLeft_GridLayout.addWidget(self.shaderTypeLabel, 2, 0, 1, 1)                           
        ...
        self.top_GridLayout.addWidget(self.assetLineEdit, 2, 0, 1, 1)                                 
        ...
        self.top_GridLayout.addWidget(self.shaderNameLineEdit, 2, 1, 1, 1)                            
        ...
        self.top_GridLayout.addWidget(self.variationLineEdit, 2, 3, 1, 1)                             
        ...
        sizePolicy.setHorizontalStretch(0)                                                            
        sizePolicy.setVerticalStretch(0)                                                              
        sizePolicy.setHeightForWidth(self.geoAssignedListWidget.sizePolicy().hasHeightForWidth())     
        self.geoAssignedListWidget.setSizePolicy(sizePolicy)                                          
        self.geoAssignedListWidget.setMinimumSize(QtCore.QSize(0, 250))                               
        ...
        self.horizontalLayout.addWidget(self.setNameButton)
        ...
        self.horizontalLayout.addWidget(self.setNodeNameButton)
    ...
    def retranslateUi(self, shaderRenamerGUI):
        ...
        self.nodeTypeLabel.setText(QtGui.QApplication.translate("shaderRenamerGUI", "Node type", None, QtGui.QApplication.UnicodeUTF8))
        self.shaderTypeLabel.setText(QtGui.QApplication.translate("shaderRenamerGUI", "Shader type", None, QtGui.QApplication.UnicodeUTF8))
